...
public final class PluginAggregator implements Plugin {
	...
	@Override
	public boolean sqlMapSelectBySelectiveElementGenerated(XmlElement element, IntrospectedTable introspectedTable) {
		boolean rc = true;

		for (Plugin plugin : plugins) {
			if (!plugin.sqlMapSelectBySelectiveElementGenerated(element, introspectedTable)) {
				rc = false;
				break;
			}
		}
	...
	public boolean sqlMapSelectCountBySelectiveElementGenerated(XmlElement element,
		...
		for (Plugin plugin : plugins) {
			if (!plugin.sqlMapSelectCountBySelectiveElementGenerated(element, introspectedTable)) {
				rc = false;
				break;
			}
		}
	...
	// 自定义方法
	@Override
	public boolean clientSelectBySelectiveMethodGenerated(Method method, Interface interfaze,
			IntrospectedTable introspectedTable) {
		boolean rc = true;

		for (Plugin plugin : plugins) {
			if (!plugin.clientSelectBySelectiveMethodGenerated(method, interfaze, introspectedTable)) {
				rc = false;
				break;
			}
		}
	...
	@Override
	public boolean clientSelectBySelectiveMethodGenerated(Method method, TopLevelClass topLevelClass,
			IntrospectedTable introspectedTable) {
		// TODO Auto-generated method stub
		boolean rc = true;

		for (Plugin plugin : plugins) {
			if (!plugin.clientSelectBySelectiveMethodGenerated(method, topLevelClass, introspectedTable)) {
				rc = false;
				break;
			}
		}
	...
	// 自定义方法
	@Override
	public boolean clientSelectCountBySelectiveMethodGenerated(Method method, Interface interfaze,
			IntrospectedTable introspectedTable) {
		boolean rc = true;

		for (Plugin plugin : plugins) {
			if (!plugin.clientSelectCountBySelectiveMethodGenerated(method, interfaze, introspectedTable)) {
				rc = false;
				break;
			}
		}
	...
	@Override
	public boolean clientSelectCountBySelectiveMethodGenerated(Method method, TopLevelClass topLevelClass,
			IntrospectedTable introspectedTable) {
		boolean rc = true;

		for (Plugin plugin : plugins) {
			if (!plugin.clientSelectCountBySelectiveMethodGenerated(method, topLevelClass, introspectedTable)) {
				rc = false;
				break;
			}
		}
