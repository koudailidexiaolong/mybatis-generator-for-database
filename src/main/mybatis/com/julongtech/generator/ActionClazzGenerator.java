 ...
 * action 模板
 * @author julong
 * @date 2023年11月26日 下午2:46:01
 * @desc 
 */
public class ActionClazzGenerator extends ClazzGenerator{

	private static final Logger logger = LoggerFactory.getLogger(ActionClazzGenerator.class);
	
	private final static String FILE_NAME = "Action.java";
	
	private final static String PACKAGE_NAME = "action";
	
	public final static String TEMPLATE_NAME = "TemplateAction.ftl";
	...
	public boolean createClazzFile(String data,DataParam param) throws IOException{
		...
		logger.info("【action模板】-生成action成功");
		//文件名
		return true;
	}
}
